...
ALIYUN_REGISTRY="crpi-l5hqyivs4ugmh6ca.cn-hangzhou.personal.cr.aliyuncs.com"
NAMESPACE="dev-mingliu"
IMAGE_NAME="ai-agent-station-front"
IMAGE_TAG="latest"
ALIYUN_USERNAME="lliu12138"
ALIYUN_PASSWORD="vae20000608"
# # 读取本地配置文件
...
docker tag ${IMAGE_NAME}:${IMAGE_TAG} ${ALIYUN_REGISTRY}/${NAMESPACE}/${IMAGE_NAME}:${IMAGE_TAG}
